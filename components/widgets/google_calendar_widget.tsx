...
import { createClient } from "@/utils/supabase/client"; // Ensure this is the correct path to your supabase client
...
const GoogleCalendarWidget = ({ access_token }: any) => {
	...
	useEffect(() => {
		// First render: calculate max events
		calculateMaxEvents();
	}, []);
											...
											<li
												...
												ref={
													index === 0
														? eventRef
														: null
												} // Only attach ref to the first event
											>
												{event.summary}
											</li>
										))}
