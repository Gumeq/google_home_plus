...
const WeatherWidget = dynamic(() => import("../widgets/weather_widget"), {
	ssr: false,
});
const GoogleCalendarWidget = dynamic(
	() => import("../widgets/google_calendar_widget"),
	{
		ssr: false,
	}
);
const YoutubeWidget = dynamic(() => import("../widgets/youtube_widget"), {
	ssr: false,
});
const LinkWidget = dynamic(() => import("../widgets/link_widget"), {
	ssr: false,
});
const GmailWidget = dynamic(() => import("../widgets/gmail_latest_widget"), {
	ssr: false,
});
const LocalNewsWidget = dynamic(() => import("../widgets/local_news_widget"), {
	ssr: false,
});
...
const CustomizableGrid: React.FC<CustomizableGridProps> = React.memo(
	({
		layout,
		onLayoutChange,
		isEditable,
		...
		const renderWidget = useCallback(
			(type: string, props?: any) => {
				switch (type) {
					...
					case "calendar":
						return (
							<GoogleCalendarWidget access_token={access_token} />
						);
					case "gmail_latest":
